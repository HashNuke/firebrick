...
(function() {
  ...
  config = function($routeProvider, $locationProvider, $httpProvider) {
    ...
    unauthorizedInterceptor = [
      '$rootScope', '$q', '$location', function(scope, $q, $location) {
        var error, success;
...
(function() {
  ...
  app.factory('Thread', function($resource) {
    ...
    return $resource("/api/threads/:collectionRoute:id/:memberRoute:category", {
      id: "@id",
      category: "@category",
  ...
  app.factory('User', function($resource) {
    ...
    return $resource("/api/users/:collectionRoute:id/:memberRoute", {
      id: "@id",
      collectionRoute: '@collectionRoute',
      memberRoute: '@memberRoute'
    }, customActions);
  ...
  app.factory('Domain', function($resource) {
    return $resource("/api/domains/:collectionRoute:id/:memberRoute", {
      id: "@id",
      collectionRoute: '@collectionRoute',
      memberRoute: '@memberRoute'
    });
...
(function() {
  app.controller('DomainsCtrl', function($scope, SharedData, Domain, domains) {
    $scope.sharedData = SharedData;
    $scope.sharedData.title = "Domains";
    $scope.domains = domains;
    $scope.addDomain = function() {
      return Domain.save($scope.newDomain, function(data) {
        if (data["errors"]) {
    ...
    return $scope.removeDomain = function(index) {
      var errorCallback, successCallback;
      successCallback = function() {
        return $scope.domains.splice(index, 1);
      };
      errorCallback = function() {};
      return $scope.domains[index].$delete(successCallback, errorCallback);
    };
  });

}).call(this);
(function() {
  app.controller('MailsCtrl', function($scope, SharedData) {
    $scope.sharedData = SharedData;
    return $scope.sharedData.title = "Main";
  });
...
(function() {
  app.controller('RootCtrl', function($scope, $location, SharedData, Session) {
    ...
    return $scope.logout = function() {
      ...
      return Session["delete"]({}, successCallback, errorCallback);
    };
  });

}).call(this);
(function() {
  app.controller('SessionCtrl', function($scope, $location, SharedData, Session, auth) {
    $scope.sharedData = SharedData;
    $scope.sharedData.title = "Firebrick";
    $scope.loginLabel = "Login";
    if ((auth.user != null) && (auth.user.error == null)) {
    ...
    return $scope.login = function() {
      ...
      successCallback = function(data) {
        if (data.user != null) {
          ...
          return $scope.loginLabel = "Login again";
        }
      };
      errorCallback = function(response) {
      ...
      return Session.save($scope.session, successCallback, errorCallback);
    };
  });
...
(function() {
  app.controller('UserCtrl', function($scope, $route, $location, SharedData, Domain, User, user) {
    var domainsErrorCallback, domainsSuccessCallback;
    $scope.sharedData = SharedData;
    domainsSuccessCallback = function(data) {
      $scope.domains = data;
      if (!$scope.user.domain_id) {
        return $scope.user.domain_id = $scope.domains[0].id;
      }
    };
    domainsErrorCallback = function() {
    ...
    return $scope.saveUser = function() {
      ...
      if (!$scope.user.id) {
        return User.save($scope.user, successCallback, errorCallback);
      } else {
        user = $scope.user;
        return user.$update(successCallback, errorCallback);
      }
    };
  });
...
(function() {
  app.controller('UsersListCtrl', function($scope, SharedData, User, users) {
    var errorCallback, successCallback;
    $scope.sharedData = SharedData;
    ...
    $scope.removeUser = function(index) {
      ...
      errorCallback = function() {};
      return $scope.users[index].$delete(successCallback, errorCallback);
    };
    successCallback = function(data) {
      return $scope.users = data;
    };
    return errorCallback = function() {
      return console.log("error");
    };
  });
